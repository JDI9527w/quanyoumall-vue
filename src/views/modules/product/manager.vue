<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="skuId" header-align="center" align="center" label="skuId" width="100"></el-table-column>
      <el-table-column prop="skuName" header-align="center" align="center" label="名称" width="550"></el-table-column>
    ...
    getDataList() {
      ...
      this.$http({
        ...
        params: this.$http.adornParams({
          ...
          minPrice: this.dataForm.price.min,
          maxPrice: this.dataForm.price.max
        })
      }).then(({ data }) => {
        if (data && data.code === 0) {
