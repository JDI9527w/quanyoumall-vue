    ...
    <el-row :gutter="20">
      <el-col :span="4">
        <div class="grid-content bg-purple">
          <category-tree @node-clicked="treeNodeClick"></category-tree>
        </div>
      </el-col>
      <el-col :span="20">
        <div class="grid-content bg-purple">
          <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            <el-form-item>
              <el-input v-model="dataForm.key" placeholder="组名" clearable @clear="resetKey"></el-input>
            </el-form-item>
            <el-form-item>
...
<script>
import categoryTree from '../../common/category'
