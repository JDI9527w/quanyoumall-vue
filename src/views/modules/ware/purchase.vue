  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="仓库id">
        <el-input style="width:120px;" v-model="dataForm.wareId" placeholder="仓库id" clearable></el-input>
      </el-form-item>
      <el-form-item label="采购单id">
        <el-input style="width:120px;" v-model="dataForm.purchaseId" placeholder="采购单id" clearable></el-input>
      </el-form-item>
      <el-form-item>
